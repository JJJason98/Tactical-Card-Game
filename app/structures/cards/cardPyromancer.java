...
public class cardPyromancer extends Card {
    public void UseCard(ActorRef out, GameState gameState, Tile tile){
        BasicCommands.addPlayer1Notification(out, "Enemy summoned Pyromancer on tile [ "+(tile.getTilex()+1) + ", " + (tile.getTiley()+1) + " ].", 1);
        ...
        gameState.getBotUnits().get(gameState.getBotUnits().size()-1).setName("Pyromancer");
